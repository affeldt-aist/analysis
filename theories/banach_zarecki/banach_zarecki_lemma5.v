...
have sorted_X' : (sorted <%R X').
  by apply: itv_partition_sorted partX'.
have X'ab : (forall x, x \in X' -> x \in `]a, b[).
  admit. (* oops *)
have := @variation_merge _ f a b ab p X' cf pabp (*abp_led*) sorted_X' X'ab.
move/le_trans; apply.
apply: leeD2l.
(* unifcf *)
rewrite -/m.
