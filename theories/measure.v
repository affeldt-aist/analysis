...
by rewrite (reindex_bigcup f^-1%FUN setT)//=; exact: measurable_bigcup.
Qed.
...
Lemma measure_bigcup A : (forall i : nat, measurable (A i)) ->
  ...
  mu (\bigcup_n A n) = \sum_(i <oo) mu (A i).
Proof.
by move=> Am Atriv; rewrite measure_semi_bigcup//; apply: measurable_bigcup.
Qed.
...
Arguments dirac_measure {d T} _ {R}.
...
have h := @measure_sigma_additive _ _ _ mu _ mF' tF'.
